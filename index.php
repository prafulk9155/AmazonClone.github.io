...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a href="signinn.php" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Cart <span class="badge">0</span>	</a>
				...
				<li><a href="signin.html" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Sign In</a>
	...
	<div>
	<a href="customer_registration.php">Sign Up</a></li>
...
<p> Developed by <b>PRAFUL KUMAR<b></p>
</footer></div>
